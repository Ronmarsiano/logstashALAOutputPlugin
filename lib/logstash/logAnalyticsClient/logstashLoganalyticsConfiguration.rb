...
class LogstashLoganalyticsOutputConfiguration
    ...
    def initialize(workspace_id, workspace_key, custom_log_table_name, endpoint='odds.opinsights.azure.com', time_generated_field='', key_names=[], key_types={}, plugin_flush_interval=5, decrease_factor= 100, amount_resizing=true, max_items=2000, proxy, logger)
