...
class LogStashAutoResizeBuffer
    ...
    def handle_window_size(amount_of_documents)
        ...
        @semaphore.synchronize do
            ...
            if buffer_status == BufferState.enum.FULL_WINDOW_RESIZE and [2*@logstash_event_buffer.get_buffer_size, @MAX_WINDOW_SIZE].min != @logstash_event_buffer.get_buffer_size
            ...
            elsif buffer_status == BufferState.enum.TIME_REACHED_WINDOW_RESIZE and [@logstash_event_buffer.get_buffer_size/2,1].max != @logstash_event_buffer.get_buffer_size
